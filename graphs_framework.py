...
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalCollisions24Band, label='RACH')
plt.plot(totalDevices2, totalCollisions24Band2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalCollisions24Band3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalCollisions24Band4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalCollisions24Band5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:4], totalCollisions24Band[:4])
plt.plot(totalDevices2[:4], totalCollisions24Band2[:4])
plt.plot(totalDevices2[:4], totalCollisions24Band3[:4])
plt.plot(totalDevices2[:4], totalCollisions24Band4[:4])
plt.plot(totalDevices2[:4], totalCollisions24Band5[:4])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Number of collisions')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[3:], totalCollisions24Band[3:])
plt.plot(totalDevices2[3:], totalCollisions24Band2[3:])
plt.plot(totalDevices2[3:], totalCollisions24Band3[3:])
plt.plot(totalDevices2[3:], totalCollisions24Band4[3:])
plt.plot(totalDevices2[3:], totalCollisions24Band5[3:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalCollisionsNetwork, label='RACH')
plt.plot(totalDevices2, totalCollisionsNetwork2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalCollisionsNetwork3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalCollisionsNetwork4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalCollisionsNetwork5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:5], totalCollisionsNetwork[:5])
plt.plot(totalDevices2[:5], totalCollisionsNetwork2[:5])
plt.plot(totalDevices2[:5], totalCollisionsNetwork3[:5])
plt.plot(totalDevices2[:5], totalCollisionsNetwork4[:5])
plt.plot(totalDevices2[:5], totalCollisionsNetwork5[:5])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Number of collisions')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[4:], totalCollisionsNetwork[4:])
plt.plot(totalDevices2[4:], totalCollisionsNetwork2[4:])
plt.plot(totalDevices2[4:], totalCollisionsNetwork3[4:])
plt.plot(totalDevices2[4:], totalCollisionsNetwork4[4:])
plt.plot(totalDevices2[4:], totalCollisionsNetwork5[4:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalCollisions, label='RACH')
plt.plot(totalDevices2, totalCollisions2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalCollisions3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalCollisions4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalCollisions5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:5], totalCollisions[:5])
plt.plot(totalDevices2[:5], totalCollisions2[:5])
plt.plot(totalDevices2[:5], totalCollisions3[:5])
plt.plot(totalDevices2[:5], totalCollisions4[:5])
plt.plot(totalDevices2[:5], totalCollisions5[:5])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Number of collisions')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[4:], totalCollisions[4:])
plt.plot(totalDevices2[4:], totalCollisions2[4:])
plt.plot(totalDevices2[4:], totalCollisions3[4:])
plt.plot(totalDevices2[4:], totalCollisions4[4:])
plt.plot(totalDevices2[4:], totalCollisions5[4:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalEnergy24Band, label='RACH')
plt.plot(totalDevices2, totalEnergy24Band2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalEnergy24Band3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalEnergy24Band4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergy24Band5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:5], totalEnergy24Band[:5])
plt.plot(totalDevices2[:5], totalEnergy24Band2[:5])
plt.plot(totalDevices2[:5], totalEnergy24Band3[:5])
plt.plot(totalDevices2[:5], totalEnergy24Band4[:5])
plt.plot(totalDevices2[:5], totalEnergy24Band5[:5])
plt.ylabel('Energy consumption (units)')
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[4:], totalEnergy24Band[4:])
plt.plot(totalDevices2[4:], totalEnergy24Band2[4:])
plt.plot(totalDevices2[4:], totalEnergy24Band3[4:])
plt.plot(totalDevices2[4:], totalEnergy24Band4[4:])
plt.plot(totalDevices2[4:], totalEnergy24Band5[4:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalEnergyNetwork, label='RACH')
plt.plot(totalDevices2, totalEnergyNetwork2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalEnergyNetwork3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalEnergyNetwork4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergyNetwork5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:5], totalEnergyNetwork[:5])
plt.plot(totalDevices2[:5], totalEnergyNetwork2[:5])
plt.plot(totalDevices2[:5], totalEnergyNetwork3[:5])
plt.plot(totalDevices2[:5], totalEnergyNetwork4[:5])
plt.plot(totalDevices2[:5], totalEnergyNetwork5[:5])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Energy consumption (units)')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[4:], totalEnergyNetwork[4:])
plt.plot(totalDevices2[4:], totalEnergyNetwork2[4:])
plt.plot(totalDevices2[4:], totalEnergyNetwork3[4:])
plt.plot(totalDevices2[4:], totalEnergyNetwork4[4:])
plt.plot(totalDevices2[4:], totalEnergyNetwork5[4:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalEnergy, label='RACH')
plt.plot(totalDevices2, totalEnergy2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalEnergy3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalEnergy4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergy5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:5], totalEnergy[:5])
plt.plot(totalDevices2[:5], totalEnergy2[:5])
plt.plot(totalDevices2[:5], totalEnergy3[:5])
plt.plot(totalDevices2[:5], totalEnergy4[:5])
plt.plot(totalDevices2[:5], totalEnergy5[:5])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Energy consumption (units)')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[4:], totalEnergy[4:])
plt.plot(totalDevices2[4:], totalEnergy2[4:])
plt.plot(totalDevices2[4:], totalEnergy3[4:])
plt.plot(totalDevices2[4:], totalEnergy4[4:])
plt.plot(totalDevices2[4:], totalEnergy5[4:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(2, 1, 1)
plt.plot(totalDevices, totalEnergyGNB, label='RACH')
plt.plot(totalDevices2, totalEnergyGNB2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalEnergyGNB3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalEnergyGNB4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergyGNB5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(2, 2, 3)
plt.plot(totalDevices[:5], totalEnergyGNB[:5])
plt.plot(totalDevices2[:5], totalEnergyGNB2[:5])
plt.plot(totalDevices2[:5], totalEnergyGNB3[:5])
plt.plot(totalDevices2[:5], totalEnergyGNB4[:5])
plt.plot(totalDevices2[:5], totalEnergyGNB5[:5])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Energy consumption (units)')
plt.grid(True)
##########
plt.subplot(2, 2, 4)
plt.plot(totalDevices[4:], totalEnergyGNB[4:])
plt.plot(totalDevices2[4:], totalEnergyGNB2[4:])
plt.plot(totalDevices2[4:], totalEnergyGNB3[4:])
plt.plot(totalDevices2[4:], totalEnergyGNB4[4:])
plt.plot(totalDevices2[4:], totalEnergyGNB5[4:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
...
plt.figure(figsize=(10, 10))
plt.subplot(4, 1, 1)
plt.plot(totalDevices, totalTimeForRegistration, label='RACH')
plt.plot(totalDevices2, totalTimeForRegistration2, label='RACH + Framework (after SIB1)')
plt.plot(totalDevices2, totalTimeForRegistration3, label='RACH + Framework (before SIB1)')
plt.plot(totalDevices2, totalTimeForRegistration4, label='RACH + Framework (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalTimeForRegistration5, label='RACH + Framework (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
##########
plt.subplot(4, 2, 3)
plt.plot(totalDevices[:2], totalTimeForRegistration[:2])
plt.plot(totalDevices2[:2], totalTimeForRegistration2[:2])
plt.plot(totalDevices2[:2], totalTimeForRegistration3[:2])
plt.plot(totalDevices2[:2], totalTimeForRegistration4[:2])
plt.plot(totalDevices2[:2], totalTimeForRegistration5[:2])
plt.ylabel('Time (ms)')
plt.grid(True)
##########
plt.subplot(4, 2, 4)
plt.plot(totalDevices[1:3], totalTimeForRegistration[1:3])
plt.plot(totalDevices2[1:3], totalTimeForRegistration2[1:3])
plt.plot(totalDevices2[1:3], totalTimeForRegistration3[1:3])
plt.plot(totalDevices2[1:3], totalTimeForRegistration4[1:3])
plt.plot(totalDevices2[1:3], totalTimeForRegistration5[1:3])
plt.grid(True)
##########
plt.subplot(4, 2, 5)
plt.plot(totalDevices[2:4], totalTimeForRegistration[2:4])
plt.plot(totalDevices2[2:4], totalTimeForRegistration2[2:4])
plt.plot(totalDevices2[2:4], totalTimeForRegistration3[2:4])
plt.plot(totalDevices2[2:4], totalTimeForRegistration4[2:4])
plt.plot(totalDevices2[2:4], totalTimeForRegistration5[2:4])
plt.ylabel('Time (ms)')
plt.grid(True)
##########
plt.subplot(4, 2, 6)
plt.plot(totalDevices[3:5], totalTimeForRegistration[3:5])
plt.plot(totalDevices2[3:5], totalTimeForRegistration2[3:5])
plt.plot(totalDevices2[3:5], totalTimeForRegistration3[3:5])
plt.plot(totalDevices2[3:5], totalTimeForRegistration4[3:5])
plt.plot(totalDevices2[3:5], totalTimeForRegistration5[3:5])
plt.grid(True)
##########
plt.subplot(4, 2, 7)
plt.plot(totalDevices[4:6], totalTimeForRegistration[4:6])
plt.plot(totalDevices2[4:6], totalTimeForRegistration2[4:6])
plt.plot(totalDevices2[4:6], totalTimeForRegistration3[4:6])
plt.plot(totalDevices2[4:6], totalTimeForRegistration4[4:6])
plt.plot(totalDevices2[4:6], totalTimeForRegistration5[4:6])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Time (ms)')
plt.grid(True)
##########
plt.subplot(4, 2, 8)
plt.plot(totalDevices[5:], totalTimeForRegistration[5:])
plt.plot(totalDevices2[5:], totalTimeForRegistration2[5:])
plt.plot(totalDevices2[5:], totalTimeForRegistration3[5:])
plt.plot(totalDevices2[5:], totalTimeForRegistration4[5:])
plt.plot(totalDevices2[5:], totalTimeForRegistration5[5:])
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.grid(True)
